...
main_surv_no_ris <- LociVS ~ MidpointLat*Sex + log10(BodyMass)*Sex + surviv*Sex + MatingSys*Sex
...
main_clutch_no_ris <- LociVS ~ MidpointLat*Sex + log10(BodyMass)*Sex + clutch*Sex + MatingSys*Sex
